...
/** Search + filter controls for the Lessons page (mirrors TaskFilters). */
          ...
          <div className="grid gap-4 px-4 pb-6">
            ...
            <div className="grid gap-1.5">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  onChange({ ...filters, period: v as LessonFilterState["period"] })
                }
              >
                <SelectTrigger className="w-full" aria-label="Filter by period">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  ...
                  <SelectItem value="past">Past lessons</SelectItem>
                </SelectContent>
              </Select>
            </div>
...
const DEFAULT_RESET: LessonFilterState = {
  search: "",
  status: "all",
  subject: "all",
  classGrade: "all",
